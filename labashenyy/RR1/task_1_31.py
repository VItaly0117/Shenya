...
def find_max_flow(*flows):
    ...
    print(f"DEBUG (Трасування): Отримано аргументів: {len(flows)}. Значення: {flows}")
...
if __name__ == "__main__":
    ...
    print(f"Потік 1: {flow1_ls} л/с")
    print(f"Потік 2: {flow2_ls} л/с")
    ...
    print(f"Найбільша швидкість: {best_flow} л/с")